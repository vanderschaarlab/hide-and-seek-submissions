...
from .utils_seeker import assess, show_all_variables
...
def dclogan_seeker(generated_data, enlarged_data):
    ...
    for i in range(train_size):
        data = full_stack_data[i, :, :].reshape((1, 100, 71, 1))
...
#      config1.beta1 = 0.5
#      if FLAGS.train:
      dcgan.train(batch_size=300, train_size=train_size, dataset="hide_and_seek_", learning_rate = 0.0002, beta1 = 0.5, epoch = 3, checkpoint_dir = "checkpoint")
#      else:
