...
import numpy as np
from .utils import extract_time, rnn_cell, random_generator, batch_generator#, random_generator_limited_noise


def timegan (ori_data, Z_master):
  """TimeGAN function.
  ...
  parameters['iterations'] = 10#20000
...
#    Z_mb = random_generator(batch_size, z_dim, T_mb, max_seq_len)
    Z_mb = Z_master(np.random.uniform(0, no*2, 128))
    # Train generator       
...
#  size_of_vectors = np.shape(ori_data)[0]
#  Z_master = list()
#  for i in range(no_*2):
#    temp = np.zeros([max_seq_len, z_dim])
#    temp_Z = np.random.uniform(0., 1, [T_mb[i], z_dim])
#    temp[:T_mb[i],:] = temp_Z
#    Z_master.append(temp_Z)
#  Z_mb = Z_master(np.random.uniform())
